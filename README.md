...
```python
from calculator_pkg_ex_ebh import FileCalculator
...
```bash
pip3 install calculator_pkg_ex_ebh
```
...
```
cd calculator_pkg_ex_ebh
pytest calculator_pkg_ex_ebh
ruff check calculator_pkg_ex_ebh
ruff format calculator_pkg_ex_ebh
mypy calculator_pkg_ex_ebh
```
